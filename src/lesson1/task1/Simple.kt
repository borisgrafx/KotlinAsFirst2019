 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = PI / 180 * (deg + min / 60 + sec / 3600)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial.toDouble() + (initial.toDouble() / 100 * percent)) / 100 * percent
